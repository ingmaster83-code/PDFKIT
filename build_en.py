...
PAGE_META = {
    ...
    'pdf-edit.html': {
        'title': 'PDF Editor Free Online – Add Text, Shapes & Images Anywhere | WooaPDF',
        'desc':  'Freely place text, shapes, images, and whiteout boxes anywhere on your PDF. Free online PDF editor, no signup, no server upload — everything runs in your browser.',
        'kw':    'PDF editor, edit PDF online, add text to PDF, draw shapes on PDF, insert image PDF, whiteout PDF, free PDF editor',
        'og_title': 'PDF Editor Free Online – Free Placement Editing | WooaPDF',
        'og_desc':  'Add text, shapes, and images anywhere on your PDF with a free canvas-based editor. No signup, no server upload.',
        'app_name': 'PDF Editor',
        'faq': [
            ('How is this different from the Watermark tool?',
             'Watermark automatically repeats the same text across every page. This editor lets you place text, shapes, and images one at a time, anywhere you choose, on any page.'),
            ('Can I edit the existing text in the PDF directly?',
             'Not yet. You can add new text on top of the page or cover existing content with a whiteout box. Direct text editing is planned for a future update.'),
            ('Is my file uploaded to a server?',
             'No. All processing happens entirely in your browser. Your file is never sent to any server.'),
        ],
        'h1': 'PDF Editor – Freely Place Text, Shapes & Images',
        'tool_desc': 'Draw text, shapes, images, and whiteout boxes anywhere you like on your PDF. All processing runs locally in your browser.',
        'breadcrumb': 'PDF Editor',
        'cross_banner_text': 'Need to add the same watermark to every page instead?',
        'cross_banner_link_text': '💧 Add Watermark →',
        'cross_banner_href': 'watermark-pdf.html',
    },
    'pdf-reorder.html': {
    ...
    'pdf-header-footer.html': {
        'title': 'Add Header & Footer to PDF Free Online – Insert Text to PDF | WooaPDF',
        'desc':  'Add custom header and footer text to every page of your PDF for free. Set alignment, font size, and margin. 100% browser-based, no upload.',
        'kw':    'add header to PDF, add footer to PDF, PDF header footer, insert text to PDF, PDF header online free, PDF footer tool',
        'og_title': 'Add Header & Footer to PDF – Free Online | WooaPDF',
        'og_desc':  'Insert custom header and footer text to all PDF pages. Set alignment and font size. Free, no signup, no upload.',
        'app_name': 'PDF Header & Footer Tool',
        'faq': [
            ('Can I add only a header or only a footer?',
             'Yes. Just fill in the header or footer field — whichever you leave blank will not be added.'),
            ('Can I apply it to specific pages only?',
             'Currently, header and footer are applied to all pages. Per-page targeting is planned for a future update.'),
            ('Are my files sent to a server?',
             'No. All processing happens locally in your browser. Your files are never uploaded anywhere.'),
        ],
        'h1': 'Add Header & Footer to PDF – Free Online',
        'tool_desc': 'Insert custom text at the top (header) or bottom (footer) of every PDF page. Set alignment and font size. Everything runs in your browser.',
        'breadcrumb': 'PDF Header & Footer',
        'cross_banner_text': 'Want to add page numbers to your PDF?',
        'cross_banner_link_text': '🔢 Add Page Numbers →',
        'cross_banner_href': '../page-number-pdf.html',
    },
    'pdf-image-extract.html': {
        'title': 'Extract Images from PDF Free Online – Save PDF Photos & Graphics | WooaPDF',
        'desc':  'Extract all images embedded in a PDF for free. Save photos, graphics, and logos as JPG or PNG. Browser-based — files never leave your device.',
        'kw':    'extract images from PDF, PDF image extractor, save images from PDF, PDF photo extractor, extract pictures from PDF free',
        'og_title': 'Extract Images from PDF – Free Online | WooaPDF',
        'og_desc':  'Pull out all images from a PDF in seconds. Save as JPG or PNG. Free, no signup, no upload to server.',
        'app_name': 'PDF Image Extractor',
        'faq': [
            ('What image formats can be extracted?',
             'Images are extracted and saved as JPG or PNG depending on the original format embedded in the PDF.'),
            ('Will all images in the PDF be extracted?',
             'Yes. The tool scans all pages and extracts every embedded image it finds.'),
        ...
        'tool_desc': 'Upload a PDF and extract all embedded images instantly. Save photos and graphics as JPG or PNG. All processing happens in your browser.',
        'breadcrumb': 'PDF Image Extract',
        'cross_banner_text': 'Want to convert the whole PDF to images?',
        'cross_banner_link_text': '🖼️ PDF to JPG →',
        'cross_banner_href': '../pdf-to-jpg.html',
    },
    'pdf-metadata.html': {
        'title': 'Edit PDF Metadata Free Online – Change PDF Title, Author & Keywords | WooaPDF',
        'desc':  'Edit PDF metadata (title, author, subject, keywords) for free. View and modify document properties instantly in your browser. No upload required.',
        'kw':    'edit PDF metadata, change PDF title, PDF author editor, PDF properties editor, PDF metadata online free, modify PDF info',
        'og_title': 'Edit PDF Metadata – Free Online | WooaPDF',
        'og_desc':  'View and edit PDF title, author, subject, and keywords. Free, no signup. All done in your browser.',
        'app_name': 'PDF Metadata Editor',
        'faq': [
            ('What metadata fields can I edit?',
             'You can edit the title, author, subject, keywords, creator, and producer fields of the PDF.'),
            ('Will editing metadata affect the PDF content?',
             'No. Only the document properties are changed. The PDF content and formatting remain untouched.'),
            ('Are my files sent to a server?',
             'No. All processing happens locally in your browser. Your files are never uploaded anywhere.'),
        ],
        'h1': 'Edit PDF Metadata – Free Online',
        'tool_desc': 'View and edit PDF document properties including title, author, subject, and keywords. Everything runs in your browser — no upload needed.',
        'breadcrumb': 'PDF Metadata',
        'cross_banner_text': 'Want to protect your PDF with a password?',
        'cross_banner_link_text': '🔐 Protect PDF →',
        'cross_banner_href': '../pdf-password.html',
    },
    'pdf-resize.html': {
        'title': 'Resize PDF Pages Free Online – Change PDF Page Size to A4, Letter, A3 | WooaPDF',
        'desc':  'Resize PDF pages to A4, A3, A5, Letter, or Legal for free. Content is automatically scaled to fit. Browser-based, no upload to server.',
        'kw':    'resize PDF pages, change PDF page size, PDF to A4, PDF to Letter, PDF page size changer free, convert PDF page size online',
        'og_title': 'Resize PDF Pages Free – A4, Letter, A3 | WooaPDF',
        'og_desc':  'Change PDF page size to A4, A3, Letter and more. Content auto-scaled. Free, no signup, no upload.',
        'app_name': 'PDF Page Resizer',
        'faq': [
            ('Which page sizes are supported?',
             'A3, A4, A5, Letter (US), and Legal (US) are supported.'),
            ('Will the content be scaled automatically?',
             'Yes. The content on each page is automatically scaled to fit the new page size.'),
            ('Are my files sent to a server?',
             'No. All processing is done locally in your browser. Nothing is sent to any server.'),
        ],
        'h1': 'Resize PDF Pages – Free Online',
        'tool_desc': 'Change the page size of your PDF to A4, A3, A5, Letter, or Legal. Content is auto-scaled to fit. All processing happens in your browser.',
        'breadcrumb': 'PDF Resize',
        'cross_banner_text': 'Want to rotate PDF pages instead?',
        'cross_banner_link_text': '🔄 Rotate PDF →',
        'cross_banner_href': '../rotate-pdf.html',
    },
    'pdf-compare.html': {
        'title': 'PDF Comparison Tool Free Online – Compare Two PDF Files | WooaPDF',
        'desc':  'Compare two PDF files and highlight added or deleted text. Side-by-side diff view with color coding. Free, browser-based, no upload.',
        'kw':    'PDF compare, compare PDF files, PDF diff, PDF text comparison, compare two PDFs online free, PDF difference checker',
        'og_title': 'PDF Comparison Tool – Free Online | WooaPDF',
        'og_desc':  'Compare two PDFs and see added/deleted text highlighted in color. Free, no signup, no upload.',
        'app_name': 'PDF Comparison Tool',
        'faq': [
            ('How does the PDF comparison work?',
             'Text is extracted from each PDF, then compared line by line. Added text is highlighted in green, deleted text in red.'),
            ('Can I compare scanned image PDFs?',
             'Scanned PDFs without a text layer cannot be compared. This tool works best with text-based PDFs.'),
            ('Are my files uploaded to a server?',
             'No. All processing happens locally in your browser. Nothing is sent to any server.'),
        ],
        'h1': 'PDF Comparison Tool – Compare Two PDFs Side by Side',
        'tool_desc': 'Upload two PDF files to compare their text content. Added and deleted lines are highlighted in color. Everything runs in your browser.',
        'breadcrumb': 'PDF Compare',
        'cross_banner_text': 'Want to compare images with a before/after slider?',
        'cross_banner_link_text': '🖼️ WooaImage Image Compare →',
        'cross_banner_href': 'https://imagekit.wooahouse.com/image-compare.html',
    },
    'pdf-odd-even.html': {
        'title': 'PDF Odd Even Page Splitter Free Online – Extract Odd or Even Pages | WooaPDF',
        'desc':  'Extract odd or even pages from a PDF for free. Perfect for duplex printing. Download as separate PDF files. Browser-based, no upload.',
        'kw':    'PDF odd even pages, extract odd pages PDF, extract even pages PDF, PDF page splitter, duplex printing PDF, odd even PDF free',
        'og_title': 'PDF Odd Even Page Splitter – Free Online | WooaPDF',
        'og_desc':  'Split PDF into odd and even pages. Perfect for duplex printing. Free, no signup, no upload.',
        'app_name': 'PDF Odd/Even Page Splitter',
        'faq': [
            ('Where is splitting by odd/even pages useful?',
             'It is useful for duplex printing when your printer does not support it, or for organizing scanned pages from a double-sided document.'),
            ('Is the original PDF preserved?',
             'Yes. The original file is untouched and a new PDF is created for download.'),
            ('Can I download both odd and even pages at once?',
             'Yes. Select "Odd + Even (both)" to download both files one after another.'),
        ],
        'h1': 'PDF Odd/Even Page Splitter – Extract Odd or Even Pages',
        'tool_desc': 'Upload a PDF to extract only its odd or even pages into a new file. Great for duplex printing. All processing happens in your browser.',
        'breadcrumb': 'PDF Odd/Even Split',
        'cross_banner_text': 'Want to split your PDF by a custom page range?',
        'cross_banner_link_text': '✂️ PDF Split Tool →',
        'cross_banner_href': '../split-pdf.html',
    },
    'pptx-to-pdf.html': {
        'title': 'PPTX to PDF Converter Free Online – Convert PowerPoint to PDF | WooaPDF',
        'desc':  'Convert PowerPoint PPTX files to PDF for free. Renders slides in your browser and exports as a multi-page PDF. No upload, no signup.',
        'kw':    'PPTX to PDF, PowerPoint to PDF, convert PPTX to PDF free, PPT to PDF online, presentation to PDF, browser PPTX converter',
        'og_title': 'PPTX to PDF Converter – Free Online | WooaPDF',
        'og_desc':  'Convert PowerPoint presentations to PDF instantly. All slides rendered in your browser. Free, no signup, no upload.',
        'app_name': 'PPTX to PDF Converter',
        'faq': [
            ('What PowerPoint file formats are supported?',
             'The tool supports .pptx files (PowerPoint 2007 and later). Legacy .ppt files are not supported.'),
            ('Will the layout and images be preserved?',
             'Yes. Slide backgrounds, images, and text are all rendered. Complex animations or embedded videos are not shown since this is a static export.'),
            ('Are my files uploaded to a server?',
             'No. All processing happens locally in your browser. Your files are never sent to any server.'),
        ],
        'h1': 'PPTX to PDF Converter – Free Online',
        'tool_desc': 'Upload a .pptx file and each slide will be rendered and exported as a page in a PDF document. Everything runs in your browser — nothing is uploaded.',
        'breadcrumb': 'PPTX → PDF',
        'cross_banner_text': 'Need to convert Word or Excel files to PDF?',
        'cross_banner_link_text': '📝 Word/Excel to PDF →',
        'cross_banner_href': '../office-to-pdf.html',
    },
    'pdf-to-csv.html': {
        'title': 'PDF to CSV Converter Free Online – Extract PDF Table Data to Excel | WooaPDF',
        'desc':  'Convert PDF text and table data to CSV format for free. Open in Excel directly. Browser-based, no upload to server.',
        'kw':    'PDF to CSV, PDF to Excel, extract PDF table, PDF data extraction, convert PDF to CSV free, PDF table extractor online',
        'og_title': 'PDF to CSV Converter – Free Online | WooaPDF',
        'og_desc':  'Extract PDF table data to CSV. Open in Excel instantly. Free, no signup, no upload.',
        'app_name': 'PDF to CSV Converter',
        'faq': [
            ('Which PDFs give the best results?',
             'Text-based PDFs with clearly defined tables work best. Scanned image PDFs without a text layer are not supported.'),
            ('How do I open the CSV in Excel?',
             'Download the CSV file and open it in Excel. If Korean characters appear garbled, select UTF-8 BOM encoding and re-convert.'),
            ('What happens with multi-page PDFs?',
             'Data from all pages is combined in order. Page separators are included to help you identify where each page starts.'),
        ],
        'h1': 'PDF to CSV Converter – Extract PDF Table Data to Excel',
        'tool_desc': 'Upload a PDF to extract its text and table data as CSV. Open the result directly in Excel. All processing happens in your browser.',
        'breadcrumb': 'PDF → CSV',
        'cross_banner_text': 'Just need plain text from a PDF?',
        'cross_banner_link_text': '📋 PDF Text Extract →',
        'cross_banner_href': '../pdf-text-extract.html',
    },
}
